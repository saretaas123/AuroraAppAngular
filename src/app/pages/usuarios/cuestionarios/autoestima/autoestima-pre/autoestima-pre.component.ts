...
@Component({
  selector: 'app-autoestima-pre',
  templateUrl: './autoestima-pre.component.html',
  styleUrls: ['./autoestima-pre.component.css']
})
export class AutoestimaPreComponent implements OnInit {
