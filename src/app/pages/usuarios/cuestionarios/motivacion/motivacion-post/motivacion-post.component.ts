...
@Component({
  selector: 'app-motivacion-post',
  templateUrl: './motivacion-post.component.html',
  styleUrls: ['./motivacion-post.component.css']
})
export class MotivacionPostComponent implements OnInit {
