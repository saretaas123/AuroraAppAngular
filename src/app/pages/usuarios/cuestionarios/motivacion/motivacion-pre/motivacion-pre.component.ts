...
@Component({
  selector: 'app-motivacion-pre',
  templateUrl: './motivacion-pre.component.html',
  styleUrls: ['./motivacion-pre.component.css']
})
export class MotivacionPreComponent implements OnInit {
