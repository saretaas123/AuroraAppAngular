...
export class TablaResultadosProAutonomiaComponent implements OnInit {
  ...
  objAPIRpta_objPacienteRespuestasCuestionarioAutonomiaPostRespuestasFullInfo : any =
  {
  ...
  ngOnInit(): void {
    ...
    this.PintarLosDatosCuestionariosAutonomiaPostResultadosEnLaPatanllaPrincipal(this.g_routeparam_CasoPacienteId);
  }
  ...
  PintarLosDatosCuestionariosAutonomiaPostResultadosEnLaPatanllaPrincipal(p_PacienteId : string)
  {
      ...
      .subscribe( APIRpta3 => {
       ...
       this.objAPIRpta_objPacienteRespuestasCuestionarioAutonomiaPostRespuestasFullInfo = this.subeEstructuraApi3.respuestas;
      });
  }
