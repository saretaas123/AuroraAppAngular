...
const routes:Routes=[
  {path:'dashboard/:psicologoid', component:PagesComponent,
   children:[
    ...
    {path:'posttest/:casopacienteid',component:ProtestComponent},
    ...
    {path:'resultados-autoestima-post/:casopacienteid',component:ResultadosAutoestimaProComponent},
    {path:'resultados-autonomia-post/:casopacienteid',component:ResultadosAutonomiaProComponent},
    {path: 'resultados-decisiones-post/:casopacienteid',component:ResultadosDecisionesProComponent},
    {path:'resultados-motivacion-post/:casopacienteid',component:ResultadosMotivacionProComponent},
